...
def speakToGod():
    ...
    """The only gay pride parade where I live is in my bedroom.""",\
    ...
    """No."""]
    print("God says:\n"+str(knowlegeOfGod[random.randint(1,9)]))
speakToGod()
